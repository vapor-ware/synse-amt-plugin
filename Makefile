...
PKG_CTX := github.com/vapor-ware/synse-amt-plugin/vendor/github.com/vapor-ware/synse-sdk/sdk
LDFLAGS := -w \
...
.PHONY: deploy
deploy:  ## Run a local deployment the plugin with Synse Server
